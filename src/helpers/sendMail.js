        ...
        <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color:#ffffff;border-radius:8px;overflow:hidden;">
          <tr>
            <td align="center" style="padding:30px;">
              <h1 style="margin:0;font-size:32px;color:#1a1a1a;">SISTEMA DE TIEMPOS</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:0 30px 30px 30px;">
              ...
              <p style="margin:0 0 20px 0;font-size:16px;line-height:1.5;">
                ¡Bienvenido a <strong>SISTEMA DE TIEMPOS</strong>! 
              </p>
              <p style="margin:0 0 20px 0;font-size:16px;line-height:1.5;">
          ...
          <tr>
            <td style="background-color:#f9f9f9;padding:20px 30px;text-align:center;font-size:12px;color:#777777;">
              <p style="margin:0;"> Tu amor te da la más cordial bienvenida   .</p>
              <p style="margin:0;">&copy; 2025 sistemas. Todos los derechos reservados.</p>
            </td>
          </tr>
        </table>
      </td>
